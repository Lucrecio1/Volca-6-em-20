...
$(document).ready(function() {
    ...
    $("#fecharcad_Hosp").click(function(event) {
        event.preventDefault();
        $("#cadHosp").hide("slow");
        $("#id_tabela1").show(1000);
        $("#id_tabela2").show(1000);
...
$(document).ready(function() {
 ...
 // Ativar outros campos do admin
 $("#maicapos_2").click(function(event) {
    event.preventDefault();
    $("#camposmais_1").show("slow"); 
    $("#mencapos_3").show(1000);       
    $("#tud_ad").hide("slow");
    $("#maicapos_2").hide("slow");

 });  
 $("#mencapos_3").click(function(event) {
    event.preventDefault();
    $("#tud_ad ").show("slow"); 
    $("#maicapos_2").show(1000);       
    $("#camposmais_1").hide("slow");
    $("#mencapos_3").hide("slow");

 });  
 // Mas ativar outros campos da doença
